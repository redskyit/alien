...
The `alien` executable is the nodejs runtime bundled with the minified and uglified javascript code and generated by [pkg](https://www.npmjs.com/package/pkg).
